...
public class WhatsappMessageService {
    ...
    public WhatsappMessageService(@Qualifier("inMemoryRepo") RedisRepository redisRepository) {
     ...
     */
    public String getCustomerFormDataField(
            String msisdn, String country, String dataLabel, WhatsappMessageDataLabelType dataLabelType) {
        // construct the redis set's key
    ...
    public Map<String, String> getCustomerFormDataFields(
            String msisdn, String country, WhatsappMessageDataLabelType dataLabelType) {
        // construct the redis set's key
        var redisKey = RedisKeyPrefix.COLLECTED_DATA.getValue() + country + ":" + msisdn;
